        ...
        <section
            ...
            <div className="flex gap-4 md:gap-8 lg:gap-12 mb-6 md:mb-4 lg:mb-10">
                <img
                    ...
                    className="h-16 w-16 lg:h-18 lg:w-18"
                />
                <img
            ...
            <div className="space-y-4 text-center">
                <h1 className="text-5xl sm:text-5xl md:text-7xl lg:text-7xl font-bold text-white tracking-tight font-sf-mono">
                    Michael Ferreira{" "}
                </h1>
                <p className="text-xl sm:text-xl md:text-2xl lg:text-3xl text-red-500 font-medium font-sf-mono">
                    Computer Science & Business Student
                </p>
                <p className="text-lg sm:text-md md:text-lg lg:text-xl text-gray-200 max-w-2xl lg:max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-3 md:gap-4 lg:gap-6 mt-4 lg:mt-12 w-full sm:w-auto justify-center text-center">
                ...
                <a
                    href="#projects"
                    className="px-8 sm:px-8 py-3 md:py-3 lg:px-10 border border-red-500 text-red-500 hover:bg-red-500/10 font-medium rounded-md transition-all duration-200 hover:scale-105 text-base sm:text-base md:text-base lg:text-lg">
                    View My Projects
                </a>
            </div>
