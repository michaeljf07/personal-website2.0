          ...
          <div className="space-y-6 md:space-y-8">
            <div className="space-y-4 md:space-y-6 px-2 md:px-0">
              <p className="text-gray-100 text-base sm:text-lg md:text-lg leading-relaxed">
                I'm a builder at heart who loves bringing ideas to life. Whether
                I'm coding a new project, learning a new technology, or
                collaborating on a team, I'm always driven by curiosity and a
                desire to create impact.
              </p>
              <p className="text-gray-100 text-base sm:text-lg md:text-lg leading-relaxed">
                I'm passionate about building innovative solutions at the
                intersection of technology and business, and I'm excited to
                apply my skills in software development and business strategy to
                meaningful projects.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 md:gap-3 justify-center">
              <a
                href="https://www.cs.uwaterloo.ca"
